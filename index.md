...
<section class="quick-links">
    ...
    <div class="button-group">
        <a href="{{ '/register' | relative_url }}" class="btn btn-secondary">Golfer Registration</a>
        <a href="{{ '/sponsor' | relative_url }}" class="btn btn-secondary">Become a Sponsor</a>
        <a href="{{ site.payment_links.donate }}" class="btn btn-secondary">Make a Donation</a>
    </div>
</section>
